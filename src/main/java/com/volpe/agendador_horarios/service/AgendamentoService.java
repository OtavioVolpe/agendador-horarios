package com.volpe.agendador_horarios.service;

import com.volpe.agendador_horarios.infrastructure.entity.Agendamento;
import com.volpe.agendador_horarios.infrastructure.repository.AgendamentoRepository;
...
public class AgendamentoService {
    ...
    public Agendamento salvarAgendamento(Agendamento agendamento) {
        ...
        Agendamento agendados = agendamentoRepository.findByServiceAndDataHoraAgendamentoBetween(agendamento.getServico(), horaAgendamento, horaFim);
